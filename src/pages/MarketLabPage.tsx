...
export function MarketLabPage() {
  ...
  return <section className="market-lab">
    <header className="module-header market-lab__header"><div><span className="eyebrow">LAB / MARKET LAB v0.3</span><h1>Scientific Validation & Market Regimes</h1><p>Splits temporais, walk-forward, regimes e robustez experimental. Sem corretora, dinheiro real ou decisões por IA.</p></div><div className="market-header-actions"><button className="button market-kill" onClick={() => void marketLabRepository.activateKillSwitch()}>KILL SWITCH</button><button className="button button--primary" onClick={() => void importCsv()} disabled={busy}>+ IMPORTAR CSV</button></div></header>
