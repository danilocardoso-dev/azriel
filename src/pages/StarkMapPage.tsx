...
export function StarkMapPage() {
  ...
  async function saveRoadmap(input: StudyRoadmapInput) { setRoadmaps(await starkService.saveRoadmap(input)); setSummary(await starkService.summary()); setEditingRoadmap(null); }
  ...
  return <>
    ...
    {editingRoadmap && <RoadmapEditor roadmap={editingRoadmap === "new" ? null : editingRoadmap} knowledge={knowledgeAreas} onCancel={() => setEditingRoadmap(null)} onSave={saveRoadmap} />}
